...
rem csh -fc "G3dcmp -g3d 'G3dOGL -pm_mode' dragonf.{tmpm,orig}.trunc.pm -win1 '-key DeDtDaDc-----J' -win2 '-key ,i' -st dragonf.s3d -bigfont"
...
G3dOGL -pm_mode dragonf.tmpm.trunc.pm %A% %G1% -key "&O" -key DeDtDaDc-----J  |  G3dOGL -pm_mode dragonf.orig.trunc.pm %A% %G2% -async -killeof -input
